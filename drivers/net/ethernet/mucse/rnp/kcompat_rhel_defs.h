...
/* This is the RedHat Enterprise Linux distribution specific definitions
 * file. It defines what features need backports for a given version of the
 * RHEL kernel.
 *
 * It checks the RHEL_RELEASE_CODE and RHEL_RELEASE_VERSION macros to 
 * decide what support the target kernel has.
 *
...
#ifndef HAVE_PCI_DEV_FLAGS_NO_BUS_RESET
