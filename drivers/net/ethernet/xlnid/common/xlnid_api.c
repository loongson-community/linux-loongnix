...
/**
 *  xlnid_get_san_mac_addr - Get SAN MAC address
 *  @hw: pointer to hardware structure
...
{
	return xlnid_call_func(hw, hw->mac.ops.get_san_mac_addr,
			       (hw, san_mac_addr), XLNID_NOT_IMPLEMENTED);
}

/**
 *  xlnid_set_san_mac_addr - Write a SAN MAC address
 *  @hw: pointer to hardware structure
 *  @san_mac_addr: SAN MAC address
 *
...
{
	return xlnid_call_func(hw, hw->mac.ops.set_san_mac_addr,
			       (hw, san_mac_addr), XLNID_NOT_IMPLEMENTED);
}
...
/**
 *  xlnid_read_pba_string - Reads part number string from EEPROM
 *  @hw: pointer to hardware structure
 ...
 **/
s32 xlnid_read_pba_string(struct xlnid_hw *hw, u8 *pba_num, u32 pba_num_size)
{
	return xlnid_read_pba_string_generic(hw, pba_num, pba_num_size);
}
 ...
 *  invalid checksum.
 **/
s32 xlnid_write_eeprom_buffer(struct xlnid_hw *hw, u16 offset, u16 words,
			      u16 *data)
{
 ...
 **/
s32 xlnid_read_eeprom(struct xlnid_hw *hw, u16 offset, u16 *data)
{
